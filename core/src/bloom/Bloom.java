...
public class Bloom {
     ...
     * @param viewport
	 */
	public Bloom(Viewport viewport, float scale) {
	...
	private void gaussianBlur() {
		...
		pingPongBuffer1.end(viewport.getScreenX(), viewport.getScreenY(),
                        viewport.getScreenWidth(), viewport.getScreenHeight());
		...
		for (int i = 0; i < blurPasses; i++) {
			...
			pingPongBuffer2.end(viewport.getScreenX(), viewport.getScreenY(),
                                viewport.getScreenWidth(), viewport.getScreenHeight());
